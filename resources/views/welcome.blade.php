...
<body class="antialiased">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center w-16 h-16 rounded-full bg">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-tools-kitchen" width="24" height="24"
    ...
    <a href="#" class="text-gray-500 dark:text-gray-400">Create an account</a>
